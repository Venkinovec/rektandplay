		...
		<div class="content">
			<div class="col-md-12 single-page">
				<div class="print-main">
					<h1 class="text">Annusska</h1>
									
					<br /><img src="Annusska.jpg" alt="Profilový obrázek" width="256" height="256" align="left">
<br>
<br>
<br>
<br>
			...
			<div class="_text">
							<p class="text"><strong>Působí od:&nbsp;</strong><i>&nbsp;25.07.2016</i></p><br>

							<p class="text"><strong>
							
							<p class="text">
							<strong>Aplikace:&nbsp;</strong>
                                <a href="https://www.facebook.com/recandplay2014/?fref=ts">
