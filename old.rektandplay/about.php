		...
		<div class="max-after"></div>
			<div class="col-md-12 single-page">
				<div class="print-main">
					<h1>O nás</h1>
					<p class="likes">Text napsal: <a href="/profiles/Teluro/">Teluro</a> a <a href="/profiles/Centřík/">Centřík</a>. Poslední aktualizace textu byla dne: <a>12.07.2016</a></p>
					<p class="span">Začátky | <a>působíme od roku 2014</a></p>
					<p class="ptext">
						Text...
					</p>
				</div>
